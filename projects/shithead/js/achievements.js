...
export const ACHIEVEMENTS = [
  { id: "first_blood", name: "First Win", desc: "Win your first game (finish first).", test: (s) => s.place === 1 },
  { id: "clean_hands", name: "Clean Hands", desc: "Win without ever picking up the pile.", test: (s) => s.place === 1 && s.pickups === 0 },
  { id: "pyromaniac", name: "Pyromaniac", desc: "Burn the pile 3+ times in one game.", test: (s) => s.burns >= 3 },
  { id: "ten_outta_ten", name: "Ten Outta Ten", desc: "Win a game where you played a 10.", test: (s) => s.place === 1 && s.tens >= 1 },
  { id: "four_play", name: "Four Play", desc: "Burn with a four-of-a-kind.", test: (s) => s.fourKinds >= 1 },
